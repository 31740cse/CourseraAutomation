...
public class SearchResultPage {
	...
	public void applyFilters(Map<String, ArrayList<String>> filtersrequirements) {
		...
		for (String key : filtersrequirements.keySet()) {
			for (String value : filtersrequirements.get(key)) {
				String xpath = "//*[@data-testid='search-filter-group-" + key + "']//div[contains(@data-testid,'"
						+ value + "')]/label";
				if (driver.findElements(By.xpath(xpath)).isEmpty()) {
					driver.findElement(By.xpath(
							"//*[@data-testid='search-filter-group-" + key + "']//span[contains(text(),'Show')]"))
							.click();
				}
	...
	public static ArrayList<String> extractParticularSectionDetails(WebDriver driver, String section,
	...
	public static void extractInfoAboutFilter(WebElement elmt, String section, WebDriver driver,
			WaitHelper waitHelper) {
